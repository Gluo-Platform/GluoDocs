...
Post descriptions, reaction descriptions and client about-me sections all allow
a simple form of markdown.
...
Type \[this\](https://example.com) to get [this](https://example.com) as an 
output. 

A piece of string that start with https:// or http:// will appear as clickable 
when posted, i.e. https&colon;//google.com will output as [https://google.com](https://google.com).
